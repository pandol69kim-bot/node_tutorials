...
const formatTootipValue = (value) =>  `${value} Sales`
            ...
            TARGET_REALITY_LISTS.map((item, index) => (
              <div key={index} className='mt-4 flex items-center justify-between'>
                <div className='flex items-center gap-x-2.5'>
                  ...
                  <div>
                    <h4 className='text-ss text-[#151d48] dark:text-gray-300'>{item.title}</h4>
                    <p className='text-[10px] txt-[#a5aaa] dark:text-gray-500'>{item.subtitle}</p>
                  </div>
                </div>
                <div>
